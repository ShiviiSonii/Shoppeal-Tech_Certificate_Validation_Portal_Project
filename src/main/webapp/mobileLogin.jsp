  ...
  <body class="body">
    <div class="cont">
      ...
      <div class="light-blue-div">
        <h1 class="otp-heading">Login With Mobile No</h1>
        <form class="p-4 p-md-5">
          <div class="form-floating mb-3">
              <div class="input-group">
                  ...
                  <input type="mobile" class="form-control" id="mobileInput" placeholder="Enter Mobile No" required>
              </div>
          </div>
        <div class="login-with-shoppeal">
          <button class=" google-button btn btn-light">
